...
Anaconda 环境包含了常用的 Python 科学计算库及依赖关系，而 MooQuant 有很多模块是依赖于这些科学计算库的，因此下载 Anaconda 可以轻松搭建出一个强大的 Python 量化研发的基础环境。
...
.. code-block:: bash
    ...
    # 如您想创建一个名为mooquant的虚拟环境
    $ conda create --name mooquant python=3.5
