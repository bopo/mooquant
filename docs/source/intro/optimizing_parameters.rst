...
.. code-block:: python
	...
	for long_period in range(30, 90, 5):
		...
		"base": {
		    ...
		    "frequency": "1d",
		    "strategy_file": "mooquant/examples/golden_cross.py",
            "accounts": {
                "stock": 100000
            }
		},
...
.. code-block:: python
	...
	for long_period in range(30, 90, 5):
	    ...
	    cmd = ("mooquant run -fq 1d -f mooquant/examples/golden_cross.py --start-date 2015-01-01 --end-date 2016-01-01 "
