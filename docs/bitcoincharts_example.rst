...
http://www.bitcoincharts.com/about/markets-api/ using :class:`mooquant.bitcoincharts.barfeed.CSVTradeFeed`,
...
We can now take advantage of :class:`mooquant.barfeed.csvfeed.GenericBarFeed` to load the resampled file and backtest a
