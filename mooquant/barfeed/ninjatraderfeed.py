...
class Frequency(object):
    MINUTE = mooquant.bar.Frequency.MINUTE
    DAILY = mooquant.bar.Frequency.DAY
...
class Feed(csvfeed.BarFeed):
    """A :class:`mooquant.barfeed.csvfeed.BarFeed` that loads bars from CSV files exported from NinjaTrader.

    :param frequency: The frequency of the bars. Only **mooquant.bar.Frequency.MINUTE** or **mooquant.bar.Frequency.DAY**
        are supported.
