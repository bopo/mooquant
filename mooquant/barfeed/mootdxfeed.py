...
class RowParser(csvfeed.RowParser):
    ...
    def __parseDate(self, dateString):
        ...
        # Time on MooTDX CSV files is empty. If told to set one, do it.
...
class Feed(csvfeed.BarFeed):
    """A :class:`mooquant.barfeed.csvfeed.BarFeed` that loads bars from CSV files downloaded from MooTDX.
    ...
    .. note::
        MooTDX csv files lack timezone information.
