...
class FillStrategy(object, metaclass=abc.ABCMeta):
    ...
    def fillMarketOrder(self, broker_, order, bar):
        ...
        :type order: :class:`mooquant.broker.MarketOrder`
        :param bar: The current bar.
        :type bar: :class:`mooquant.bar.Bar`
    ...
    def fillLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`mooquant.broker.LimitOrder`
        :param bar: The current bar.
        :type bar: :class:`mooquant.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`mooquant.broker.StopOrder`
        :param bar: The current bar.
        :type bar: :class:`mooquant.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`mooquant.broker.StopLimitOrder`
        :param bar: The current bar.
        :type bar: :class:`mooquant.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
...
class DefaultStrategy(FillStrategy):
    ...
    * A :class:`mooquant.broker.MarketOrder` is always filled using the open/close price.
    * A :class:`mooquant.broker.LimitOrder` will be filled like this:
    ...
    * A :class:`mooquant.broker.StopOrder` will be filled like this:
    ...
    * A :class:`mooquant.broker.StopLimitOrder` will be filled like this:
    ...
    .. note::
        ...
        * It uses :class:`mooquant.broker.slippage.NoSlippage` slippage model by default.
