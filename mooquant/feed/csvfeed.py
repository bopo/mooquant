...
class Feed(BaseFeed):
    ...
    :param timezone: The timezone to use to localize datetimes. Check :mod:`mooquant.marketsession`.
    :type timezone: A pytz timezone.
    :param maxLen: The maximum number of values that each :class:`mooquant.dataseries.DataSeries` will hold.
