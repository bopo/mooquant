...
class BaseStrategy(object, metaclass=abc.ABCMeta):
    ...
    :type barFeed: :class:`mooquant.barfeed.BaseBarFeed`.
    :param broker: The broker that will handle orders.
    :type broker: :class:`mooquant.broker.Broker`.
    ...
    def getFeed(self):
        """Returns the :class:`mooquant.barfeed.BaseBarFeed` that this strategy is using."""
        return self.__barFeed

    def getBroker(self):
        """Returns the :class:`mooquant.broker.Broker` used to handle order executions."""
        return self.__broker

    def getCurrentDateTime(self):
        """Returns the :class:`datetime.datetime` for the current :class:`mooquant.bar.Bars`."""
    ...
    def marketOrder(self, instrument, quantity, onClose=False, goodTillCanceled=False, allOrNone=False):
        ...
        :rtype: The :class:`mooquant.broker.MarketOrder` submitted.
        """
    ...
    def limitOrder(self, instrument, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        :param allOrNone: True if the order should be completely filled or not at all.
        :type allOrNone: boolean.
        :rtype: The :class:`mooquant.broker.LimitOrder` submitted.
        """
    ...
    def stopOrder(self, instrument, stopPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        :param allOrNone: True if the order should be completely filled or not at all.
        :type allOrNone: boolean.
        :rtype: The :class:`mooquant.broker.StopOrder` submitted.
        """
    ...
    def stopLimitOrder(self, instrument, stopPrice, limitPrice, quantity, goodTillCanceled=False, allOrNone=False):
        ...
        :param allOrNone: True if the order should be completely filled or not at all.
        :type allOrNone: boolean.
        :rtype: The :class:`mooquant.broker.StopLimitOrder` submitted.
        """
    ...
    def enterLong(self, instrument, quantity, goodTillCanceled=False, allOrNone=False):
        """Generates a buy :class:`mooquant.broker.MarketOrder` to enter a long position.
    ...
    def onEnterOk(self, position):
        ...
        :type position: :class:`mooquant.strategy.position.Position`.
        """
        pass
    ...
    def onFinish(self, bars):
        ...
        :type bars: :class:`mooquant.bar.Bars`.
        """
        pass
    ...
    def onOrderUpdated(self, order):
        ...
        :type order: :class:`mooquant.broker.Order`.
        """
        pass
    ...
    def resampleBarFeed(self, frequency, callback):
        ...
        :rtype: :class:`mooquant.barfeed.BaseBarFeed`.
        """
...
class BacktestingStrategy(BaseStrategy):
    ...
    :type cash_or_brk: int/float or :class:`mooquant.broker.Broker`.
    ...
    def __init__(self, barFeed, cash_or_brk=1000000):
        ...
        if isinstance(cash_or_brk, mooquant.broker.Broker):
            broker = cash_or_brk
        else:
