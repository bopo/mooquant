...
class Position(object):
    ...
    :type strategy: :class:`mooquant.strategy.BaseStrategy`.
    :param entryOrder: The order used to enter the position.
    :type entryOrder: :class:`mooquant.broker.Order`
    ...
    def getEntryOrder(self):
        """Returns the :class:`mooquant.broker.Order` used to enter the position."""
        return self.__entryOrder

    def getExitOrder(self):
        """Returns the :class:`mooquant.broker.Order` used to exit the position. If this position hasn't been closed yet, None is returned."""
