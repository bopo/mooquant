...
from mooquant import bar, barfeed
...
class CSVTradeFeed(csvfeed.BarFeed):
    ...
    .. note::
        * A :class:`mooquant.bar.Bar` instance will be created for every trade, so open, high, low and close values will all be the same.
