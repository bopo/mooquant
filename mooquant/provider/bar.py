...
class Bars(object):
    ...
    def __contains__(self, instrument):
        """Returns True if a :class:`mooquant.bar.Bar` for the given instrument is available."""
    ...
    def getBar(self, instrument):
        """Returns the :class:`mooquant.bar.Bar` for the given instrument or None if the instrument is not found."""
