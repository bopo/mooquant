...
from mooquant.providers.netease import common, wsclient
...
class LiveTradeFeed(barfeed.BaseBarFeed):
    ...
    def getOrderBookUpdateEvent(self):
        ...
        Eventh handlers should receive one parameter:
         1. A :class:`mooquant.bitstamp.wsclient.OrderBookUpdate` instance.

        :rtype: :class:`mooquant.observer.Event`.
        """
