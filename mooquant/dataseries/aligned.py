...
class Syncer(object):
    ...
    def __onNewValue1(self, dataSeries, dateTime, value):
        ...
        # If a value for dateTime was added to first dataseries, and a value for that same datetime is also in
        # the second one
    ...
    def __onNewValue2(self, dataSeries, dateTime, value):
        ...
        # If a value for dateTime was added to second dataseries, and a value for that same datetime is also in
        # the first one
        # then append to both destination dataseries.
        if pos1 is not None:
